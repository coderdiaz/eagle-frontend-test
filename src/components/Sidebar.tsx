      ...
      <div className="inline-flex flex-col">
        ...
        <nav className="inline-block">
          <div className="flex flex-col">
            <Link href="/dashboard">
              <a className="inline-flex items-center px-5 py-3 bg-gray-700 text-gray-400">
            ...
            <Link href="/dashboard/users">
              <a className="inline-flex items-center px-5 py-3 bg-gray-700 text-gray-400 bg-opacity-10">
