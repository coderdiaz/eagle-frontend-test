          ...
          <table className="min-w-full">
            <thead>
              <tr className="border-t border-gray-200">
                <th className="px-6 py-3 border-b border-blueGray-200 bg-blueGray-50 text-left text-xs font-semibold text-blueGray-500 uppercase tracking-wider">
                ...
                <th className="px-6 py-3 border-b border-blueGray-200 bg-blueGray-50 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">
                  Correo Electrónico
                </th>
              </tr>
            </thead>
